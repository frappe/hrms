...
var T = (a, e, t) =>
		e in a
			? Q(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
			: (a[e] = t),
	B = (a, e) => {
		for (var t in e || (e = {})) W.call(e, t) && T(a, t, e[t]);
...
import { _ as ce } from "./EmptyState-38_uLDf3.js";
const G = Symbol("frappe-ui:list");
function de(a) {
	te(G, a);
}
function K() {
	...
	fe = S({
		...
		setup(a) {
			...
			const m = g(() => {
				...
				const C = i.filter((J) => t.value.includes(J)).length;
...
const Ve = S({
		...
		setup(a) {
			...
			oe(
				...
				Y(() => (t == null ? void 0 : t.setAllValues([])));
			function u(n, w) {
				return String(o(n, w));
			}
			function o(n, w) {
	...
	Me = {
		...
		emits: N(["row-click"], ["update:selection"]),
		setup(a) {
			const e = a,
				t = E(a, "selection"),
				l = g(() =>
