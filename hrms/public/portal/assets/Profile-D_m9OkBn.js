...
import { a as Ce, _ as y, b as we } from "./SectionCard-BKeIA1B1.js";
import { _ as Ae } from "./IdentityBand-DFaFZaDc.js";
import { _ as ee } from "./DataTable-KquPBl5L.js";
import { _ as c } from "./FieldRow-2cmCHPuL.js";
import { _ as ae } from "./PersonRow-BtXbdUjH.js";
import { _ as F } from "./EmptyState-DhAxAin0.js";
import { w as Ee, x as j, y as le, d as T, b as I, s as Be } from "./index-BpEXs0_U.js";
import { n as De, a as Ne, e as Pe, b as Re } from "./toast-Ca-cKV9o.js";
...
const Me = { class: "flex flex-col gap-3" },
				...
				return (
					...
					b("div", Me, [
						...
						(E = g.balances) != null && E.length
							? R("", !0)
							: (r(),
							  h(F, { key: 0, message: "No leave allocated for this period." })),
					])
				);
			};
		},
	...
	je = { class: "grid gap-3 sm:grid-cols-2" },
	Te = { key: 0, class: "flex flex-col gap-2" },
	Fe = { class: "grid gap-3 sm:grid-cols-2" },
	qe = { class: "text-base text-ink-gray-5" },
	We = {
	...
	Aa = {
		...
		setup(g) {
			const f = [
				...
				k = x(() => le.data || {}),
				w = q(f.some((t) => t.key === _.query.tab) ? _.query.tab : "about");
			U(
				() => _.query.tab,
				(t) => {
			...
			const z = x(() =>
				...
				H = x(() => {
					...
					return [
						...
						{
							label: "Joined",
							value: u.value.date_of_joining ? T(u.value.date_of_joining) : null,
						},
