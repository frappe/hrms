import { _ as g } from "./StatusBadge-DcMGXIA6.js";
import {
	o as t,
	i as a,
	g as r,
...
const _ = { class: "rounded-6 border border-outline-gray-1 bg-surface-base" },
	...
	p = { class: "truncate text-lg-semibold text-ink-gray-9 sm:text-2xl" },
	v = { class: "mt-0.5 truncate text-p-base text-ink-gray-5" },
