...
def get_korea_phase2_custom_fields():
	return {
		...
		"Salary Slip": [
			...
			{
				"fieldname": "kr_year_end_section",
				"fieldtype": "Section Break",
				"label": _("Korea Year End Settlement"),
				"insert_after": "kr_total_deductions",
			},
			{
				"fieldname": "kr_prepaid_tax",
				"fieldtype": "Currency",
				"label": _("Prepaid Tax"),
				"default": "0",
				"options": "currency",
				"read_only": 1,
				"insert_after": "kr_year_end_section",
			},
			{
				"fieldname": "kr_determined_tax",
				"fieldtype": "Currency",
				"label": _("Determined Tax"),
				"default": "0",
				"options": "currency",
				"read_only": 1,
				"insert_after": "kr_prepaid_tax",
			},
			{
				"fieldname": "kr_adjustment_tax",
				"fieldtype": "Currency",
			...
			},
			{
				...
				"fieldtype": "Data",
				"label": _("Year End Settlement Kind"),
				"read_only": 1,
				"insert_after": "kr_adjustment_tax",
			},
			{
				"fieldname": "kr_year_end_target_month",
				"fieldtype": "Data",
				"label": _("Year End Target Month"),
				"read_only": 1,
				"insert_after": "kr_year_end_settlement_kind",
			},
		],
	}
