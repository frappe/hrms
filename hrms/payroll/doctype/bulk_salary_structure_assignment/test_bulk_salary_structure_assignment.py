...
class TestBulkSalaryStructureAssignment(IntegrationTestCase):
    def setUp(self):
        ...
        self.emp2 = make_employee(
            "employee2@bssa.com", company="_Test Company", department="Accounts"
        )
        self.emp3 = make_employee(
            "employee3@bssa.com", company="_Test Company", department="Accounts"
        )
        # no department
        self.emp4 = make_employee("employee4@bssa.com", company="_Test Company")
        # different domain in employee_name
        self.emp5 = make_employee(
            "employee5@test.com", company="_Test Company", department="Accounts"
        )
    ...
    def test_get_employees(self):
        ...
        make_salary_structure(
            "Salary Structure 1", "Monthly", self.emp2, today, company="_Test Company"
        )
