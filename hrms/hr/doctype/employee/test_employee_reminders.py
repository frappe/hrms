...
from hrms.hr.doctype.employee.employee_reminders import send_holidays_reminder_in_advance
...
class TestEmployeeReminders(unittest.TestCase):
	@classmethod
	def setUpClass(cls):
		from hrms.hr.doctype.holiday_list.test_holiday_list import make_holiday_list
	...
	def test_birthday_reminders(self):
		...
		from hrms.hr.doctype.employee.employee_reminders import (
	...
	def test_work_anniversary_reminder_not_sent_for_0_years(self):
		...
		from hrms.hr.doctype.employee.employee_reminders import get_employees_having_an_event_today
	...
	def test_advance_holiday_reminders_monthly(self):
		from hrms.hr.doctype.employee.employee_reminders import send_reminders_in_advance_monthly
	...
	def test_advance_holiday_reminders_weekly(self):
		from hrms.hr.doctype.employee.employee_reminders import send_reminders_in_advance_weekly
