...
class TestOvertimeSlip(HRMSTestSuite):
	def test_holiday_map_uses_overtime_period_holiday_list(self):
		...
		holiday_list_a = make_holiday_list(
			"Test Overtime HLA A", from_date=start_date, to_date=end_date, add_weekly_offs=False
		)
		...
		create_holiday_list_assignment("Employee", employee, holiday_list_a, from_date=start_date)
		create_holiday_list_assignment("Employee", employee, holiday_list_b, from_date=getdate("2026-06-01"))
