...
>>>>>>> 5f229848d (fix(vehicle_log): enhance cancellation logic to handle linked submitted and draft Expense Claims)
...
>>>>>>> 3cf53cabd (fix(vehicle_log): improve cancellation logic to handle linked draft Expense Claims and update description handling)
