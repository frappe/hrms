    ...
    def create_or_update_attendance(self, attendance_name, date):
        ...
        if attendance_name:
            ...
            modify_half_day_status = (
                1 if doc.status == "Absent" and status == "Half Day" else 0
            )
            doc.db_set(
                {
                    "status": status,
            ...
            doc.flags.ignore_validate = (
                True  # ignores check leave record validation in attendance
            )
                    ...
                    (
                        ...
                        + "</li><li>".join(
                            get_link_to_form(
                                "Attendance",
                                a.name,
                                label=formatdate(a.attendance_date),
                            )
