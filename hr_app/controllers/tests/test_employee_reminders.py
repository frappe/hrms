...
from hr_app.controllers.employee_reminders import send_holidays_reminder_in_advance
from hr_app.hr.doctype.holiday_list_assignment.test_holiday_list_assignment import (
	create_holiday_list_assignment,
)
from hr_app.hr.doctype.hr_settings.hr_settings import set_proceed_with_frequency_change
from hr_app.hr.utils import get_holidays_for_employee
...
class TestEmployeeReminders(HRMSTestSuite):
	...
	def test_birthday_reminders(self):
		...
		from hr_app.controllers.employee_reminders import (
	...
	def test_work_anniversary_reminder_not_sent_for_0_years(self):
		...
		from hr_app.controllers.employee_reminders import get_employees_having_an_event_today
	...
	def test_advance_holiday_reminders_monthly(self):
		from hr_app.controllers.employee_reminders import send_reminders_in_advance_monthly
	...
	def test_advance_holiday_reminders_weekly(self):
		from hr_app.controllers.employee_reminders import send_reminders_in_advance_weekly
