...
from hr_app.payroll.doctype.salary_withholding.salary_withholding import link_bank_entry_in_salary_withholdings
...
class PayrollEntry(Document):
	...
	if TYPE_CHECKING:
		...
		from hr_app.payroll.doctype.payroll_employee_detail.payroll_employee_detail import PayrollEmployeeDetail
	...
	def create_overtime_slips(self) -> None:
		from hr_app.hr.doctype.overtime_slip.overtime_slip import (
	...
	def get_overtime_slip_details(self) -> list[bool]:
		from hr_app.hr.doctype.overtime_slip.overtime_slip import filter_employees_for_overtime_slip_creation
