...
from hr_app.payroll.doctype.salary_structure.salary_structure import validate_max_benefit_for_flexible_benefit
...
class SalaryStructureAssignment(Document):
	...
	if TYPE_CHECKING:
		...
		from hr_app.payroll.doctype.employee_cost_center.employee_cost_center import EmployeeCostCenter
