...
from hr_app.payroll.doctype.employee_benefit_claim.employee_benefit_claim import get_salary_structure_assignment
...
class EmployeeBenefitApplication(Document):
	...
	if TYPE_CHECKING:
		...
		from hr_app.payroll.doctype.employee_benefit_application_detail.employee_benefit_application_detail import (
