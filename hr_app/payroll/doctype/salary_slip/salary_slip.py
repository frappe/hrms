...
from hr_app.hr.utils import validate_active_employee
from hr_app.payroll.doctype.additional_salary.additional_salary import get_additional_salaries
from hr_app.payroll.doctype.employee_benefit_ledger.employee_benefit_ledger import (
	create_employee_benefit_ledger_entry,
	delete_employee_benefit_ledger_entry,
)
from hr_app.payroll.doctype.payroll_entry.payroll_entry import get_salary_withholdings, get_start_end_dates
from hr_app.payroll.doctype.payroll_period.payroll_period import (
	get_payroll_period,
	get_period_factor,
)
from hr_app.payroll.doctype.salary_slip.salary_slip_loan_utils import (
	cancel_loan_repayment_entry,
	make_loan_repayment_entry,
	process_loan_interest_accrual_and_demand,
	set_loan_repayment,
)
from hr_app.payroll.utils import sanitize_expression
from hr_app.utils.holiday_list import get_holiday_dates_between
...
class SalarySlip(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		from hr_app.payroll.doctype.employee_benefit_detail.employee_benefit_detail import EmployeeBenefitDetail
		from hr_app.payroll.doctype.salary_detail.salary_detail import SalaryDetail
		from hr_app.payroll.doctype.salary_slip_leave.salary_slip_leave import SalarySlipLeave
		from hr_app.payroll.doctype.salary_slip_timesheet.salary_slip_timesheet import SalarySlipTimesheet
	...
	def pull_sal_struct(self):
		from hr_app.payroll.doctype.salary_structure.salary_structure import make_salary_slip
...
def calculate_tax_by_tax_slab(annual_taxable_earning, tax_slab, eval_globals=None, eval_locals=None):
	from hr_app.hr.utils import calculate_tax_with_marginal_relief
...
def enqueue_email_salary_slips(names: list | str) -> None:
	...
	frappe.enqueue("hr_app.payroll.doctype.salary_slip.salary_slip.email_salary_slips", names=names)
	frappe.msgprint(
