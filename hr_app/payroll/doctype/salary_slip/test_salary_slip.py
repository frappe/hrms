...
from hr_app.hr.doctype.leave_allocation.test_leave_allocation import create_leave_allocation
from hr_app.hr.doctype.leave_type.test_leave_type import create_leave_type
from hr_app.payroll.doctype.employee_tax_exemption_declaration.test_employee_tax_exemption_declaration import (
	create_exemption_category,
	create_payroll_period,
)
from hr_app.payroll.doctype.payroll_entry.payroll_entry import get_month_details
from hr_app.payroll.doctype.salary_slip.salary_slip import (
...
from hr_app.tests.test_utils import get_email_by_subject, get_first_sunday
...
class TestSalarySlip(HRMSTestSuite):
	...
	def test_payment_days_calculation_for_lwp_on_month_boundaries(self):
		from hr_app.hr.doctype.holiday_list_assignment.test_holiday_list_assignment import (
	...
	def test_salary_slip_generation_against_opening_entries_in_ssa(self):
		...
		from hr_app.payroll.doctype.payroll_period.payroll_period import get_period_factor
		from hr_app.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_tax_payable_with_tax_relief_and_marginal_relief_limits(self):
		from hr_app.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
		from hr_app.regional.india.setup import setup
