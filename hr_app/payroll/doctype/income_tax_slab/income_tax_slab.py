...
class IncomeTaxSlab(Document):
	...
	if TYPE_CHECKING:
		...
		from hr_app.payroll.doctype.income_tax_slab_other_charges.income_tax_slab_other_charges import (
			IncomeTaxSlabOtherCharges,
		)
		from hr_app.payroll.doctype.taxable_salary_slab.taxable_salary_slab import TaxableSalarySlab
