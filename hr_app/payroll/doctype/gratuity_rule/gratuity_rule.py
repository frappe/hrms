...
class GratuityRule(Document):
	...
	if TYPE_CHECKING:
		...
		from hr_app.payroll.doctype.gratuity_applicable_component.gratuity_applicable_component import (
			GratuityApplicableComponent,
		)
		from hr_app.payroll.doctype.gratuity_rule_slab.gratuity_rule_slab import GratuityRuleSlab
