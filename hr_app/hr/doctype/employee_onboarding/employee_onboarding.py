...
from hr_app.controllers.employee_boarding_controller import EmployeeBoardingController
...
class EmployeeOnboarding(EmployeeBoardingController):
	...
	if TYPE_CHECKING:
		...
		from hr_app.hr.doctype.employee_boarding_activity.employee_boarding_activity import (
