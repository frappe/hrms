...
from hr_app.hr.doctype.employee_checkin.test_employee_checkin import make_checkin
from hr_app.hr.doctype.overtime_type.test_overtime_type import create_overtime_type
from hr_app.hr.doctype.shift_type.test_shift_type import make_shift_assignment, setup_shift_type
from hr_app.payroll.doctype.salary_slip.test_salary_slip import make_earning_salary_component
...
class TestOvertimeSlip(HRMSTestSuite):
	...
	def test_overtime_slip_creation_via_payroll_entry(self):
		...
		from hr_app.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates
		from hr_app.payroll.doctype.payroll_entry.test_payroll_entry import get_payroll_entry
