...
from hr_app.hr.doctype.attendance_request.test_attendance_request import get_employee
...
from hr_app.hr.doctype.leave_application.leave_application import get_leave_balance_on
