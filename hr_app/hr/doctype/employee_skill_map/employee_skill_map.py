...
class EmployeeSkillMap(Document):
	...
	if TYPE_CHECKING:
		...
		from hr_app.hr.doctype.employee_skill.employee_skill import EmployeeSkill
		from hr_app.hr.doctype.employee_training.employee_training import EmployeeTraining
