...
import hrms
from hr_app.hr.utils import set_employee_name, share_doc_with_approver, validate_active_employee
from hr_app.mixins.pwa_notifications import PWANotificationsMixin
...
class ExpenseClaim(AccountsController, PWANotificationsMixin):
	...
	if TYPE_CHECKING:
		...
		from hr_app.hr.doctype.expense_claim_advance.expense_claim_advance import ExpenseClaimAdvance
		from hr_app.hr.doctype.expense_claim_detail.expense_claim_detail import ExpenseClaimDetail
		from hr_app.hr.doctype.expense_taxes_and_charges.expense_taxes_and_charges import ExpenseTaxesandCharges
