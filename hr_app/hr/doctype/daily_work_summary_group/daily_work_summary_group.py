...
from hr_app.hr.doctype.daily_work_summary.daily_work_summary import get_user_emails_from_group
...
class DailyWorkSummaryGroup(Document):
	...
	if TYPE_CHECKING:
		...
		from hr_app.hr.doctype.daily_work_summary_group_user.daily_work_summary_group_user import (
