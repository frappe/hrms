...
class LeavePolicyAssignment(Document):
	...
	def calculate_leaves_for_passed_period(
		...
		from hr_app.hr.utils import get_monthly_earned_leave as get_periodically_earned_leave
		from hr_app.hr.utils import get_sub_period_start_and_end
...
def is_earned_leave_applicable_for_current_period(date_of_joining, allocate_on_day, earned_leave_frequency):
	from hr_app.hr.utils import get_semester_end, get_semester_start
