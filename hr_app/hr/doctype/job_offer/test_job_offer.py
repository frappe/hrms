...
from hr_app.hr.doctype.job_applicant.job_applicant import get_applicant_to_hire_percentage
from hr_app.hr.doctype.job_offer.job_offer import get_offer_acceptance_rate
from hr_app.hr.doctype.staffing_plan.test_staffing_plan import make_company
from hr_app.tests.test_utils import create_job_applicant
