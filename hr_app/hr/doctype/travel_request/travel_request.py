...
class TravelRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from hr_app.hr.doctype.travel_itinerary.travel_itinerary import TravelItinerary
		from hr_app.hr.doctype.travel_request_costing.travel_request_costing import TravelRequestCosting
