...
from hr_app.hr.doctype.appraisal_cycle.appraisal_cycle import validate_active_appraisal_cycle
from hr_app.hr.utils import validate_active_employee
from hr_app.mixins.appraisal import AppraisalMixin
...
class Appraisal(Document, AppraisalMixin):
	...
	if TYPE_CHECKING:
		...
		from hr_app.hr.doctype.appraisal_goal.appraisal_goal import AppraisalGoal
		from hr_app.hr.doctype.appraisal_kra.appraisal_kra import AppraisalKRA
		from hr_app.hr.doctype.employee_feedback_rating.employee_feedback_rating import EmployeeFeedbackRating
