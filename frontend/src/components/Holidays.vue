<template>
	<div class="flex flex-col gap-5 w-full">
		<div class="flex flex-row justify-between items-center">
			<div class="text-lg text-theme-page-heading font-bold">{{ __("Upcoming Holidays") }}</div>
			<div
		...
		<div class="flex flex-col bg-theme-content-box-bg rounded" v-if="upcomingHolidays?.length">
			<div
			...
			>
				<div class="flex flex-row items-center gap-3 grow">
					<FeatherIcon name="calendar" class="h-5 w-5 text-theme-content-box-text" />
	...
	>
		<div class="bg-white w-full flex flex-col items-center justify-center pb-5">
			<div class="w-full pt-8 pb-5 border-b text-center">
				<span class="text-theme-page-heading font-bold text-lg">{{ __("Holiday List") }}</span>
			</div>
			<div class="w-full flex flex-col items-center justify-center gap-5 p-4">
				...
				>
					...
					<div
						:class="[
							'text-base font-bold',
							holiday.is_upcoming ? 'text-gray-800' : 'text-theme-content-box-text-secondary',
						]"
					>
						{{ holiday.formatted_holiday_date }}
					</div>
