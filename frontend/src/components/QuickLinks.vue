<template>
	<div class="flex flex-col gap-5 my-4 w-full">
		<div class="text-lg font-medium text-theme-page-heading">{{ title || __("Quick Links") }}</div>
		<div class="flex flex-col bg-theme-content-box-bg rounded">
			...
			>
				<div class="flex flex-row items-center gap-3 grow">
					<component :is="link.icon" class="h-5 w-5 text-theme-text" />
					<div class="text-base font-normal text-theme-text">
						{{ link.title }}
					</div>
				</div>
