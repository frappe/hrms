...
| 국민연금 상한/하한 | ⚠ | `insurance.py` | 하한만 일부 반영, **상한 미구현** (2026.01~06 6,370,000 / 2026.07~2027.06 6,590,000, 하한 410,000) |
...
| 우선순위 | 갭 항목 | 영향도 | 이유 |
|---------|---------|--------|------|
| **P0** | 국민연금 상한 미구현 | 🔴 | 고소득자 과공제 (2026.01~06 월 637만 이상, 2026.07~2027.06 월 659만 이상) |
